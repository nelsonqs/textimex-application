...
import com.textimex.sales.TextimexApp;
import com.textimex.sales.config.AsyncSyncConfiguration;
import com.textimex.sales.config.EmbeddedMongo;
...
@SpringBootTest(classes = { TextimexApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
